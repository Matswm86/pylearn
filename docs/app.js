...
const ELI5_INTROS = {
  ...
  loops: "🧒 <b>Think of it like this:</b> A loop is like brushing your teeth: you do the same small move again and again until you're done. You don't write out every single brush stroke, you say \"keep brushing until the timer ends\". A <code>for</code> loop repeats once for every item in a pile. A <code>while</code> loop keeps going as long as something stays true.",
